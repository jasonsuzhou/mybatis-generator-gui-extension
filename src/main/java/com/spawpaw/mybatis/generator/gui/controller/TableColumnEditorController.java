...
public class TableColumnEditorController extends BaseController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        ObservableList<String> pageTypeList =
                FXCollections.observableArrayList("text","radio","radio-dict","checkbox","select","select-search","select-dict","select-xm","textarea","textarea-wangEdit","number","email","password","date","datetime","color");
